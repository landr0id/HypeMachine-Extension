                    ...
                    if (typeof(hasDownloadButton) === 'undefined' || !hasDownloadButton) {
                        jQuery.getJSON("/serve/source/" + id + "/" + key, function(data) {
                            ...
                            if (data.type != "SC")
                                ...
                                jQuery(track).prepend('<li class="dl"><table class="spacer"></table><a target="_top" href="https://landaire.net/id3/fix?url=' + encodeURIComponent(download_url) + '&artist=' + encodeURIComponent(artist) + '&title=' + encodeURIComponent(title) + '"' + '><table class="arrow"><tr><td><div class="rect-arrow"></div></td></tr><tr><td class="' + triArrowString + '"></td></tr></table></a></li>');
                        });
